...
export async function GET(request: Request) {
  try {
    ...
    return NextResponse.json({
      ...
      settings: {
        preTestLimitMult: settings.preTestLimitMult ?? 10,
        preTestLimitDiv: settings.preTestLimitDiv ?? 10,
        practiceLimitMult: settings.practiceLimitMult ?? 10,
        practiceLimitDiv: settings.practiceLimitDiv ?? 10,
        postTestLimitMult: settings.postTestLimitMult ?? 10,
        postTestLimitDiv: settings.postTestLimitDiv ?? 10,
        preTestTimeMult: settings.preTestTimeMult ?? 5,
        preTestTimeDiv: settings.preTestTimeDiv ?? 5,
        practiceTimeMult: settings.practiceTimeMult ?? 0,
        practiceTimeDiv: settings.practiceTimeDiv ?? 0,
        postTestTimeMult: settings.postTestTimeMult ?? 5,
        postTestTimeDiv: settings.postTestTimeDiv ?? 5,
        preTestSessionsCount: settings.preTestSessionsCount ?? 3,
        postTestSessionsCount: settings.postTestSessionsCount ?? 1,
        monitoringCooldownDays: settings.monitoringCooldownDays ?? 7,
        monitoringStagesCount: settings.monitoringStagesCount ?? 5,
      },
